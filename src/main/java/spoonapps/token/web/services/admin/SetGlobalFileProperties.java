...
import spoonapps.web.servlet.JsonPostServlet;
...
@WebServlet(value="/admin/set-file-properties",description="This set the value of one property: name, description, value",loadOnStartup=1)
@Security(constraints=TechnicalAdministratorSecurityConstraint.ID)
public class SetGlobalFileProperties extends JsonPostServlet {
	...
	@Override
	protected Object getData(HttpServletRequest request, HttpServletResponse response) throws ApplicationException, ServletException {
